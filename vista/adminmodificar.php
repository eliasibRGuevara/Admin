  ...
  <form action="../vista/actualizar.php" id="form" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="container__tabla container__tabla__editar" >
                          ...
                          <?php while($row=mysqli_fetch_assoc($resultado)){ ?>
                            ...
                            <input type="hidden" class="tabla__item" value="<?php echo $row["idusuario"];?>" name="contraseña">
                            <input type="text" class="tabla__item" value="<?php echo $row["primernombre"];?>" name="contraseña">
                              <input type="text" class="tabla__item" value="<?php echo $row["email"];?>" name="contraseña">
